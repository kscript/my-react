...
router.get('/:name', function (ctx, next) { return __awaiter(_this, void 0, void 0, function () {
    var name, _a;
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ctx.response.type = 'html';
                _a = ctx.response;
                return [4 /*yield*/, fs.readFile(path.join(process.cwd(), 'public', 'index.html'), 'utf8')];
            case 1:
                _a.body = _b.sent();
                return [2 /*return*/];
        }
